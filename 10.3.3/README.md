...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                                      | `2.5.1-debian-11-r0`         |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                                      | `2.5.1-scratch-r0`                          |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                                  | `2.5.1-scratch-r0`                          |
...
| `kubeops.image.tag`                                   | Kubeops image tag (immutable tags are recommended)                                                                  | `2.5.1-scratch-r0`         |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                                      | `2.5.1-debian-11-r0`              |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                            | `2.5.1-debian-11-r0`    |
