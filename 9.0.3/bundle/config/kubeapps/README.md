...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                         | `2.4.6-debian-11-r1`         |
...
| `apprepository.image.tag`                                   | Kubeapps AppRepository Controller image tag (immutable tags are recommended)                                        | `2.4.6-scratch-r1`                          |
...
| `apprepository.syncImage.tag`                               | Kubeapps Asset Syncer image tag (immutable tags are recommended)                                                    | `2.4.6-scratch-r1`                          |
...
| `kubeops.image.tag`                                   | Kubeops image tag (immutable tags are recommended)                                                                  | `2.4.6-scratch-r1`         |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                    | `2.4.6-debian-11-r2`              |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                            | `2.4.6-debian-11-r2`    |
